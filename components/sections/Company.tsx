  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1200px] px-6">
        ...
        >
          <p className="text-sm tracking-widest text-cyan-400 mb-4 font-poppins">
            MEDISIAN
          </p>
        ...
        >
          {features.map((feature, i) => (
            ...
            >
              <div className="gradient-circle h-44 w-44 md:h-52 md:w-52">
                <div className="gradient-circle-inner p-8">
                  <p className="whitespace-pre-line text-center text-lg font-medium leading-relaxed text-white md:text-xl">
                    {feature.title}
                  </p>
                </div>
              </div>
